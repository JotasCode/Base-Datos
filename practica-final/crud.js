...
// Ejemplo de uso
const nuevoPaciente = { id: 'TICKET-386', nombre: 'Javier', doctor: 'Dr. Hernández', casoEspecial: 'no', fechaRegistro: new Date().toLocaleString() };
crearPaciente(nuevoPaciente);
console.log('Pacientes después de agregar:', leerPacientes());

actualizarPaciente('TICKET-386', { fechaAtencion: new Date().toLocaleString() });
console.log('Paciente actualizado:', leerPacientePorId('TICKET-386'));